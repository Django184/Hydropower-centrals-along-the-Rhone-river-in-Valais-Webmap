...
var map = new ol.Map({
    ...
    layers: layersList,
    view: new ol.View({
         maxZoom: 15, minZoom: 11, projection: new ol.proj.Projection({
            code: 'EPSG:2056',
            //extent: [2494306.344000, 1078574.695590, 2679790.043200, 1204075.563000],
            units: 'm'})
    })
});

//initial view - epsg:3857 coordinates if not "Match project CRS"
map.getView().fit([2558834.818425, 1090022.643787, 2671348.880925, 1145495.356477], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Hydropower Centrals  along the Rhône River in Valais (2025)</h2>';
        return titleElement;
    })(),
