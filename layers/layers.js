...
//ol.proj.get("EPSG:2056").setExtent([2570639.814764, 1096022.610890, 2678166.481431, 1140948.860890]);
var wms_layers = [];
...
var format_Links_14 = new ol.format.GeoJSON();
var features_Links_14 = format_Links_14.readFeatures(json_Links_14, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:2056'});
var jsonSource_Links_14 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_Links_14.addFeatures(features_Links_14);
var lyr_Links_14 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_Links_14, 
                style: style_Links_14,
                popuplayertitle: 'Links',
                interactive: false,
                title: '<img src="styles/legend/Links_14.png" /> Links'
            });
var format_Lots_15 = new ol.format.GeoJSON();
var features_Lots_15 = format_Lots_15.readFeatures(json_Lots_15, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:2056'});
var jsonSource_Lots_15 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_Lots_15.addFeatures(features_Lots_15);
var lyr_Lots_15 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_Lots_15, 
                style: style_Lots_15,
                popuplayertitle: 'Lots',
                interactive: false,
                title: '<img src="styles/legend/Lots_15.png" /> Lots'
            });
...
var group_Projects = new ol.layer.Group({
                                layers: [lyr_Links_14,lyr_Lots_15,],
                                fold: 'close',
                                title: 'Projects'});
...
var group_Hydrology = new ol.layer.Group({
                                layers: [lyr_Rhnewatershed_4,lyr_Rivers_5,lyr_Hydrologicalfunctions_6,lyr_LakeGeneva_7,],
                                fold: 'close',
                                title: 'Hydrology'});
...
lyr_Valais_0.setVisible(true);lyr_Vaud_1.setVisible(true);lyr_Valais_2.setVisible(true);lyr_Vaud_3.setVisible(true);lyr_Rhnewatershed_4.setVisible(true);lyr_Rivers_5.setVisible(true);lyr_Hydrologicalfunctions_6.setVisible(true);lyr_LakeGeneva_7.setVisible(true);lyr_Links_8.setVisible(true);lyr_Outlets_9.setVisible(true);lyr_Hydropowerplants_10.setVisible(true);lyr_Links_11.setVisible(true);lyr_Outlets_12.setVisible(true);lyr_Hydropowerplants_13.setVisible(true);lyr_Links_14.setVisible(false);lyr_Lots_15.setVisible(true);lyr_Cities_16.setVisible(true);
var layersList = [group_Administrativeboundaries,group_Topography,group_Hydrology,group_NotincludedinRhnehydropeaking,group_IncludedinRhnehydropeaking,group_Projects,lyr_Cities_16];
...
lyr_Links_14.set('fieldAliases', {'id': 'id', });
lyr_Lots_15.set('fieldAliases', {'id': 'id', 'Name': 'Name', });
lyr_Cities_16.set('fieldAliases', {'fid': 'fid', 'Town': 'Town', 'Lat': 'Lat', 'Long': 'Long', });
...
lyr_Links_14.set('fieldImages', {'id': '', });
lyr_Lots_15.set('fieldImages', {'id': '', 'Name': '', });
lyr_Cities_16.set('fieldImages', {'fid': 'TextEdit', 'Town': 'TextEdit', 'Lat': 'TextEdit', 'Long': 'TextEdit', });
...
lyr_Links_14.set('fieldLabels', {'id': 'no label', });
lyr_Lots_15.set('fieldLabels', {'id': 'no label', 'Name': 'no label', });
lyr_Cities_16.set('fieldLabels', {'fid': 'hidden field', 'Town': 'hidden field', 'Lat': 'no label', 'Long': 'no label', });
lyr_Cities_16.on('precompose', function(evt) {
