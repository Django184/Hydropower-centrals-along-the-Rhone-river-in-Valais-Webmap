...
function categories_Rivers_5(feature, value, size, resolution, labelText,
        ...
        stroke: new ol.style.Stroke({color: 'rgba(137,130,211,0.36898039215686274)', lineDash: null, lineCap: 'butt', lineJoin: 'bevel', width: 12.16}),
        text: createTextStyle(feature, resolution, labelText, labelFont,
                              labelFill, placement, bufferColor,
                              bufferWidth)
    }),new ol.style.Style({
        stroke: new ol.style.Stroke({color: 'rgba(128,205,193,0.97)', lineDash: null, lineCap: 'square', lineJoin: 'bevel', width: 9.975}),
        text: createTextStyle(feature, resolution, labelText, labelFont,
                              labelFill, placement, bufferColor,
                              bufferWidth)
    })];
...
case '100 < Q < 150  m3/s':
                    return [ new ol.style.Style({
        stroke: new ol.style.Stroke({color: 'rgba(137,130,211,0.36898039215686274)', lineDash: null, lineCap: 'butt', lineJoin: 'bevel', width: 8.739999999999998}),
        text: createTextStyle(feature, resolution, labelText, labelFont,
                              labelFill, placement, bufferColor,
                              bufferWidth)
    }),new ol.style.Style({
